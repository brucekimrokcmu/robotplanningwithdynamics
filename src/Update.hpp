...
class Update
{
    public:
        ...
        StateSpace::VehicleState Motion(const StateSpace::VehicleState& s_curr, const ControlSpace::VehicleControl& u, double dt) 
        {
            ...
            k1.push_back(s_curr.v_ * sin(s_curr.theta_) * sin(s_curr.phi_));
            ...
            k2.push_back((s_curr.v_ + 0.5 * k1[3]) * sin(s_curr.theta_ + 0.5 * k1[2]) * sin(s_curr.phi_ + 0.5 * k1[4]));
            ...
            k3.push_back((s_curr.v_ + 0.5 * k2[3]) * sin(s_curr.theta_ + 0.5 * k2[2]) * sin(s_curr.phi_ + 0.5 * k2[4]));
            ...
            k4.push_back((s_curr.v_ + k3[3]) * sin(s_curr.theta_ + k3[2]) * sin(s_curr.phi_ + k3[4]));
